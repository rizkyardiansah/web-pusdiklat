                    ...
                    <div class="signup-form">
                        ...
                        <form method="POST" action="" class="register-form" id="register-form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="universitas" id="universitas" placeholder="Universitas" value="<?= set_value('universitas'); ?>"/>
                                <?= form_error('universitas', '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="fakultas"><i class="zmdi zmdi-graduation-cap"></i></label>
                                <input type="text" name="fakultas" id="fakultas" placeholder="Fakultas" value="<?= set_value('fakultas'); ?>"/>
